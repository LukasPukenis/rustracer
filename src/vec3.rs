...
mod tests {
    ...
    fn test_mul() {
        assert_eq!(
            Vec3::new_with(3.0, 3.0, 3.0),
            Vec3::new_with(0.5, 0.5, 0.5) * 6.0
        );
    }
    #[test]
    ...
    fn test_div() {
        assert_eq!(
            Vec3::new_with(1.0, 2.0, 3.0),
            Vec3::new_with(10.0, 20.0, 30.0) / Vec3::new_with(10.0, 10.0, 10.0)
        );
        assert_eq!(
            Vec3::new_with(3.0, 3.0, 3.0),
            Vec3::new_with(30.0, 30.0, 30.0) / 10.0
        );
    }
    ...
    fn test_length() {
        ...
        const K: f64 = 0.00001;
        assert!((1.73205 - Vec3::new_with(1.0, 1.0, 1.0).length()).abs() < K);
